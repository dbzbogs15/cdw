            ...
            <div class="blockcontent">
                <ul>
                    ...
                    <li class="group">
                        ...
                        <ul>
                            <li>
                                <a href="#" title="Về nobita" target="_self">
                                    Về nobita
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Tuyển dụng" target="_self">
                                    Tuyển dụng
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="group">
                        ...
                        <ul>
                            <li>
                                <a href="#" title="Tài khoản" target="_self">
                                    Tài khoản
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Danh sách đơn hàng" target="_self">
                                    Danh sách đơn hàng
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Thông báo" target="_self">
                                    Thông báo
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="group">
                        ...
                        <ul>
                            <li>
                                <a href="#" title="Hướng dẫn mua hàng" target="_self">
                                    Hướng dẫn mua hàng
                                </a>
                            </li>
                            <li>
                                <a href="#" title="Phương thức thanh toán" target="_self">
                            ...
                            <li>
                                <a href="#" title="Phương thức vận chuyển" target="_self">
    ...
    <div class="footer_address">
        <div class="block "
            ...
            <div class="blockcontent">
                ...
                <div style="text-align: center;">Địa chỉ: 25/5 Thăng Long, P. 4, Quận T&acirc;n B&igrave;nh, TP. Hồ Ch&iacute; Minh
                </div>
                <div style="text-align: center;">
                    &nbsp;
                </div>
                <div style="text-align: center;">
                    <a href="#" target="_blank"><img alt="" src="#" style="width: 220px; height: 83px;"/></a>
                </div>
                <div style="text-align: center;">
                    &nbsp;
                </div>
...
<div class="homecoupon">
    ...
    <form action="#"
          onsubmit="updateemail(this); return false;"
          id="homecoupon">
        <div align="center"
             style="margin:5px">
        ...
        <span id="help1"></span>
        <input type="hidden"
               name="Cedaac0fa7cce07dd548868b8930eaec8"
               value="1"/>
    </form>
</div>
<div class="coupon">
    <a href="javascript:"
       onclick="showdialog(1)">Ưu
        đãi</a>
</div>
<div id='bttop'
     class="bttop">

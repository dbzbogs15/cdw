...
<div class="blockcontent">
    <div style="position:relative; padding:0 20px; overflow:hidden; height:340px">
            ...
            <div class="product_contener">
                <div class="products">
                    <div class="image"><a
                            ...
                            title="ANH LÀ TẤT CẢ NHỮNG GÌ EM GHÉT NHẤT - TẶNG KÈM 5 POSTCARD + 1 THIỆP TỎ TÌNH DỄ THƯƠNG (SỐ LƯỢNG CÓ HẠN)"/></a>
                    ...
                    <div class="prices">89.380 ₫</div>
                    <div class="rootprice">109.000 ₫</div>
                </div>
            </div>
            <div class="product_contener">
                <div class="products">
                    <div class="image"><a href="/2880/boxset-anohana-doa-hoa-ngay-ay-bo-3-tap-.html"
                            ...
                            title="BOXSET ANOHANA - ĐOÁ HOA NGÀY ẤY (BỘ 3 TẬP)"/></a>
                    ...
                    <div class="prices">135.000 ₫</div>
                    <div class="rootprice">150.000 ₫</div>
                </div>
            </div>
            <div class="product_contener">
                <div class="products">
                    <div class="image"><a
                            ...
                            title="DATE A LIVE - TẬP 3 - TẶNG KÈM BOOKMARK (SỐ LƯỢNG CÓ HẠN)"/></a>
                    ...
                    <div class="prices">83.300 ₫</div>
                    <div class="rootprice">98.000 ₫</div>
                </div>
            </div>
            <div class="product_contener">
                <div class="products">
        ...
        <div class="clear"></div>
        <div class="list_btn">
            <a onclick="publishing(-1);" id="pprev" class="prev" href="javascript:"><i
                    class="fa fa-chevron-left"></i></a>
            <a onclick="publishing(1);" id="pnext" class="next" href="javascript:"><i

<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<div class="blockcontent"><h1>
    <span style="font-size:16px;"><span style="font-family:arial,helvetica,sans-serif;">Mua S&aacute;ch Online Tại Nobita.Vn</span></span>
</h1>
    <p>
    ...
    <p>
        <span style="font-family:arial,helvetica,sans-serif;"><span style="font-size:12px;">Ngo&agrave;i ra, với h&igrave;nh thức <strong>Giao h&agrave;ng thu tiền tận nơi</strong> v&agrave; <strong>Đổi h&agrave;ng trong v&ograve;ng 7 ng&agrave;y</strong> nếu s&aacute;ch c&oacute; bất kỳ lỗi n&agrave;o trong qu&aacute; tr&igrave;nh in ấn sẽ gi&uacute;p Qu&yacute; kh&aacute;ch y&ecirc;n t&acirc;m hơn khi mua sắm tại Nobita.vn</span></span>
    </p>
    <div>
        &nbsp;
    </div>

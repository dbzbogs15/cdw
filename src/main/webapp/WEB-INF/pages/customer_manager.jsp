            ...
            <div class="block"
                ...
                <div class="blockcontent">
                    <div class="customer">
                        ...
                        <p>
                            Trong mục quản lý tài khoản, bạn có thể xem các hoạt động gần đây của bạn và cấp nhật thông tin
                            tài khoản. Chọn một link bên dưới để xem hoặc chỉnh sửa thông tin.
                        </p>
                    </div>
                    <div class="customer">
                        <h3>
                        ...
                        <table cellpadding="0"
                            ...
                            <tr>
                                <th align="left" width="50%">
                                    Thông tin liên hệ
                                    <a class="more"
                                       href="/customers/edit/index.html"
                                       title="Thay đổi">Thay đổi
                                    </a>
                                </th>
                                <th align="left">
                                    Địa chỉ giao hàng mặc định
                                    <a class="more"
                                       href="/customers/address/index.html">
                                        Sổ địa chỉ
                                    </a>
                                </th>
                            </tr>
                            <tr>
                                <td valign="top">
                                    ...
                                    <div class="cfield">
                                        <a href="/account/change-password" title="Sửa mật khẩu">
                                            Sửa mật khẩu
                                        </a>
                                    </div>
                                </td>

                                ...
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                            ...
                                            <span class="text-dark">1.78%</span> <small></small></h6>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                                class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i>
                                            <span class="text-dark">25.87</span> <small>USD</small></h6>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                                class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i>
                                            <span class="text-dark">87,4517</span> <small>USD</small></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                                class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i>
                                            <span class="text-dark">3.94%</span> <small></small></h6>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                            ...
                                            <span class="text-dark">16.25</span> <small>USD</small></h6>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-center mt-3">
                                        ...
                                        <h6 class="font-18"><i
                                                class="mdi mdi-arrow-up-bold-hexagon-outline text-success"></i>
                                            <span class="text-dark">124,858.67</span> <small>USD</small></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inbox-widget slimscroll" style="max-height: 370px;">
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-1.jpg"
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-2.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-3.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-4.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-5.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-6.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-8.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="/resources/admin/assets/images/users/avatar-9.jpg"
                                                                         class="rounded-circle bx-shadow-lg" alt=""></div>
...
<!-- Chart JS -->
<script src="/resources/admin/plugins/chart.js/chart.bundle.js"></script>

<!-- init dashboard -->
<script src="/resources/admin/assets/pages/jquery.dashboard.init.js"></script>

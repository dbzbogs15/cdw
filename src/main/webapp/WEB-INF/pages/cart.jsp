                                                    ...
                                                    <tr id="list${cart.book.id}">
                                                        ...
                                                        <td class="quantity" align="right" width="20%">
                                                            ...
                                                            <div style="padding-right:15px">
                                                                <a href="javascript:"
                                                                   onclick="changequantity(2, ${cart.book.id}, 0);">
                                                                    Xóa
                                                                </a>
                                                            </div>
                                                        </td>
                                        ...
                                        <table cellpadding="2"
                                            ...
                                            <tr class="actions">
                                                ...
                                                <td align="right"
                                                    ...
                                                    <a href="/order"
                                                       class="redbuttom">Thực hiện thanh toán
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
...
<script type="text/javascript">
    function validateUserInput() {
        ...
        //Phím chức năng
        //Phím chử
        //Các phím kí hiệu và F
        // 46 = 0, 8 = Back space
        //Nút muổi tên trái phải

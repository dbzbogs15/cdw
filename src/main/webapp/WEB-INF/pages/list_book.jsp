        ...
        <div class="sortable" id="layoutGroup1">
            <div class="block" id="module_listnewproducts">
                ...
                <div class="pagesright">
                    <div class="views">
                        <a class="active fa fa-th-large"
                           href="/sach-moi.html?page=1"
                           title="Xem danh sách theo dạng lưới"></a>
                        <a class=" fa fa-th-list"
                           href="/sach-moi.html?page=1&view=1"
                        ...
                        <div class="product_contener">
                            <div class="products">
                                ...
                                <div class="productname">
                                    <a href="/product?bookid=${item.id}" title="${item.name}">${item.name}</a>
                                </div>
                                ...
                                <span class="rootprice"><fmt:formatNumber
                                        pattern="###,###"
                ...
                <ul class="pagenav"
                    ...
                    <c:if test="${currentPage < totalPage}">
                        <li class="next">
                            <a href="${currentUrl}?page=${currentPage + 1}">Trang sau
